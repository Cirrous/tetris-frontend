...
<template>
  <ul>
    ...
    <li>
      <RouterLink to='/game'>
        <svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='currentColor' class='bi bi-controller'
             viewBox='0 0 16 16'>
          <path
    ...
    <li>
      <RouterLink to='/leaderboard'>
        <svg xmlns='http://www.w3.org/2000/svg' width='30' height='30' fill='currentColor' class='bi bi-trophy'
             viewBox='0 0 16 16'>
          <path
